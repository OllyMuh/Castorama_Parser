# Scrapy settings for advparser project
#
...
SPIDER_MODULES = ['advparser.spiders']
NEWSPIDER_MODULE = 'advparser.spiders'
...
#SPIDER_MIDDLEWARES = {
#    'advparser.middlewares.AdvparserSpiderMiddleware': 543,
#}

# Enable or disable downloader middlewares
# See https://docs.scrapy.org/en/latest/topics/downloader-middleware.html
#DOWNLOADER_MIDDLEWARES = {
#    'advparser.middlewares.AdvparserDownloaderMiddleware': 543,
#}
...
ITEM_PIPELINES = {
   'advparser.pipelines.AdvparserPipeline': 300,
   'advparser.pipelines.AdvPhotosPipeline': 200
}
